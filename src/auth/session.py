...
async def _refresh_session():
    ...
    try:
        ...
        print("🔄 Refreshing session with enhanced anti-detection...")
        ...
        # Enhanced headers with randomization and better fingerprinting
        user_agents = [
        ...
        print("✅ Enhanced session created with anti-detection measures")
